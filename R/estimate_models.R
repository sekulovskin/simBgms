...
#' @param no_cores Numeric. The number of CPU cores to use for parallel computation.
...
#' @param inclusion_probability	 The prior edge inclusion probability for the Bernoulli model. Can be a single probability, or a matrix of p rows and p columns specifying an inclusion probability for each edge pair. The default is inclusion_probability = 0.5.
...
#' @param g.prior Numeric. The prior probability of an edge in Gaussian Graphical Models (only relevant if level = "Gaussian").
